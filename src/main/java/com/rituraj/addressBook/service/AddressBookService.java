...
import com.rituraj.addressBook.exception.ContactAlreadyExistsException;
    ...
    public class AddressBookService {
        ...
        public ResponseEntity<Response> addContact(ContactAddDTO contactAddDTO) {
            ...
            if (optionalPerson.isPresent()) {
                throw new ContactAlreadyExistsException("Contact already exists with same name.");
            }
        ...
        public ResponseEntity<Response> updateEmail(EmailUpdateDTO emailUpdateDTO) {
            Person person = personRepo.findById(emailUpdateDTO.getPerson_id())
                    .orElseThrow(() -> new ContactNotFoundException("Contact not found with ID: " + emailUpdateDTO.getPerson_id()));

            if (!person.getIsActive()) {
                throw new ContactNotFoundException("Contact is inactive.");
            }
